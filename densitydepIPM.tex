...
%The peak length frequency of age-1 fish in Year 1 near $z = 105$ mm is seen as a peak in Year 2 near 185 mm, a peak near 305 mm in Year 3, before becoming nearly unidentifiable in the graphs for Years 7 and 9.  
%This is consistent with the lifespan reported for gizzard that can range, on average, between 4 to 6 years \citep{bodola1955life}. 
...
After fitting two adult survival parameters to LTRM data from the main channel of the Mississippi River, we compared a simulated length distribution with LTRM data collected from the La Grange Reach of the Illinois River from 1992 to 2020. 
