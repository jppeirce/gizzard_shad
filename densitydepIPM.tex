...
For gizzard shad, previous work has suggested that fish densities can play an important role in both the survival and the length-distribution patterns observed in these fish populations.  
For example, \citep{buynak1992differential} and \citep{welker1994growth} reported inverse relationships between densities and both survival and lengths of age-0 gizzard shad under both field and semi-natural conditions.  
