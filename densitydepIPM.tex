...
Given this, it is important to understand how populations of this species vary with changing environmental circumstances, such as the occurance of invasive species. Herein we use both LTRM data and parameters gleaned from other emiperical studies to develop an integral projection model for gizzard shad and test model outputs against patterns reported from a well-studied population of thsi species from the Illinois River.   
