...
\begin{figure}  \label{fig:LTRMmain}
\centering
...
\centering
%\begin{subfigure}[b]{.43\textwidth}
  \includegraphics[width=.5\textwidth]{figures/initial_sim.png}
\caption{Simulated frequency of lengths of gizzard shad.  Initial density  and N=50}
\label{fig:length_dist}
%\end{subfigure}
%\begin{subfigure}[b]{.43\textwidth}
