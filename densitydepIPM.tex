...
While not all observed length distributions are reflected in the simulations, the similarity in the average length distributions (Figure \ref{fig:lagrange}) suggest that our IPM may serve as a solid tool for predicting length distributions for gizzard shad across differnt populations. (LAST SENTENCE NEEDS A LOT MORE CLARITY)
